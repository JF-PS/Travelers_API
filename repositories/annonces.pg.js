...
const CategoriesVehiculeLangage =
  require("../models").CategoriesVehiculeLangage;
const SousCategoriesVehiculeLangage =
  require("../models").SousCategoriesVehiculeLangage;
const MarquesVehiculeLangage = require("../models").MarquesVehiculeLangage;
const CarburantsVehiculeLangage =
  require("../models").CarburantsVehiculeLangage;
            ...
            include: [
              {
                ...
                as: "type_annonce",
                include: [
                  { model: TypeAnnonceLangage, as: "type_annonce_info" },
                ],
              },
            ],
          },
          ...
          },
          {
            ...
            include: [
              ...
              { model: PhotoVehicule, as: "photo" },
              {
                ...
                as: "categorie",
                include: [
                  { model: CategoriesVehiculeLangage, as: "categorie_info" },
                ],
              },
              {
                ...
                include: [
                  {
                    model: SousCategoriesVehiculeLangage,
                    as: "sous_categorie_info",
                  },
                ],
              },
              {
              ...
              },
              {
                ...
                as: "carburant",
                include: [
                  { model: CarburantsVehiculeLangage, as: "carburant_info" },
                ],
              },
            ],
          },
                    ...
                    { model: VilleVehiculeLangage, as: "ville_info" },
                    {
                      ...
                      include: [
                        { model: DepartementLangage, as: "departement_info" },
                        {
                          ...
                          as: "region",
                          include: [
                            { model: RegionLangage, as: "region_info" },
                          ],
                        },
                      ],
                    },
            ...
            },
            {
              ...
              include: [
                ...
                },
                {
                  ...
                  as: "marque",
                  include: [
                    { model: MarquesVehiculeLangage, as: "marque_info" },
                  ],
                },
                {
                  model: CarburantsVehicule,
