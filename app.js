...
app.use(
  ...
  geolocalisationRoutes(
    express,
    geolocalisationsController(geolocalisationsRepository)
  )
);
app.use(
  "/spots_publications",
  spot_publicationRoutes(
    express,
    spots_publicationsController(spots_publicationsRepository)
  )
);
app.use(
  "/annonces",
  annonceRoutes(express, annoncesController(annoncesRepository))
);
app.use("/chats", chatRoutes(express, chatsController(chatsRepository)));
app.use(
  "/messages",
  messageRoutes(express, messagesController(messagesRepository))
);
